/**
 * https://raw.githubusercontent.com/lit/lit/main/packages/labs/gen-wrapper-react/src/index.ts
 * @license
...
import { FileTree } from './gen-utils/file-utils.js';
import { javascript, kabobToOnEvent } from './gen-utils/str-utils.js';
